...
<head>
    ...
    <link rel="stylesheet" href="archivo/css/comutacion.css">
...
<body>
    ...
    <header class="hero">
        <nav class="nav_hero">
            <div class="container nav_container">
                <div class="logo">
                    <h2 class="logo"> Conmutación de Redes de Datos<span class="point">.</span></h2>
                </div>
                <div class="links">
    ...
    <main>
        ...
        <section class="services">
            <section class="projects container">
                <h2 class="subtitle">Ing.Jose Luis Gutierrez Rivera<br><span class="point">Ofrece</span></h2>
                <p class="copy_section">creación de redes de área local eficientes y gestionables</p>
                <p class="copy_section">enrutamiento</p>
                <p class="copy_section">formando una red global interconectada</p>
                <p class="copy_section">LAN Y WAN</p>
    ...
    ?>
                    ...
                    <img src="archivo/img/conmutacion.jpg" alt="escuela" class="background_img">
                    <div class="background_text">
                        <h3 class="background_title">Contacto del profesor</h3>
                        <p class="background_copy">+52 627 120 7289 <br> no-reply@classroom.google.com<br></p>
                    </div>
                </div>
            </section>
        </section>
