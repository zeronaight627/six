...
<head>
    ...
    <link rel="stylesheet" href="archivo/css/sistemas.css">
...
<body>
    ...
    <header class="hero">
        <nav class="nav_hero">
            <div class="container nav_container">
                <div class="logo">
                    <h2 class="logo"> SISTEMAS OPERATIVOS<span class="point">.</span></h2>
                </div>
                <div class="links">
                    ...
                    <a href="aplicaciones.php" class="link link--active">aplicaciones</a>
                </div>
            </div>
        </nav>
    ...
    <main>
        ...
        <section class="services">
            <section class="projects container">
                <h2 class="subtitle">Maria de Lourdes Garcia Carrasco<br><span class="point">Ofrece</span></h2>
                <p class="copy_section">manipular las computadoras y el software </p>
                <p class="copy_section">servicios y aplicaciones </p>
                <p class="copy_section">creacion de usuarios </p>
                <p class="copy_section">sistemas operaticos: windows, linux, ubuntu y DOS. </p>
    ...
    ?>
                    ...
                    <img src="archivo/img/Sistemas.jpg" alt="escuela" class="background_img">
                    <div class="background_text">
                        <h3 class="background_title">Contacto del profesor</h3>
                        <p class="background_copy">+52 627 <br> no-reply@classroom.google.com<br></p>
                    </div>
                </div>
            </section>
        </section>
