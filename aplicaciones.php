...
<head>
    ...
    <link rel="stylesheet" href="archivo/css/aplicaciones.css">
...
<body>
    ...
    <header class="hero">
        <nav class="nav_hero">
            <div class="container nav_container">
                <div class="logo">
                    <h2 class="logo">Aplicaciones Web <span class="point">.</span></h2>
                </div>
                <div class="links">
                <a href="nube.php" class="identificarse">inicio</a>
                    <a href="infraestructura.php" class="link">infraestructura</a>
                    <a href="sistemas.php" class="datos">sistemas</a>
                    <a href="comutacion.php" class="link link--active">comutacion</a>
                </div>
            </div>
        </nav>
        ...
        <section class="container hero_main">
            ...
            <img src="archivo/img/juan.jpg" alt="es" class="mockup">
        </section>
    </header>
    <main>
        ...
        <section class="services">
            <section class="projects container">
                <h2 class="subtitle"> Ing.Juan Alberto Rodriguez Moreno<br><span class="point">Ofrece</span></h2>
                <p class="copy_section">Diseño de la arquitectura </p>
                <p class="copy_section">Selección de tecnologías </p>
                <p class="copy_section">Desarrollo del frontend </p>
                <p class="copy_section"> Desarrollo del backend </p>
    ...
    ?>
                    ...
                    <img src="archivo/img/aplicacion.jpg" alt="escuela" class="background_img">
                    <div class="background_text">
                        <h3 class="background_title">contacto del profesor</h3>
                        <p class="background_copy">+52 627 139 5976 <br> no-reply@classroom.google.com<br></p>
                    </div>
                </div>
            </section>
        </section>
